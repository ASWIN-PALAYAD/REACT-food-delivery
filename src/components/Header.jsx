      ...
      <div className='flex items-center justify-between md:hidden w-full h-full'>
        ...
        <div className='relative'>
          ...
          cursor-pointer  hover:bg-slate-100 px-4 py-2 >' onClick={() => setIsMenu(false)}>
                ...
                <p className='m-2 p-2 rounded-md shadow-md px-4 py-2 flex items-center gap-3 cursor-pointer first-letter 
                    transition-all duration-100 ease-in-out text-red-600 text-base justify-center bg-gray-200 hover:bg-slate-300'
                    onClick={logout}>
                  Logout <MdLogout /> </p>
              </div>
            )
