  ...
  return (
    <div className='w-full min-h-screen flex items-center justify-center'>
      <div className='w-[90%] md:w-[75%] border border-gray-300 rounded-lg p-4 flex flex-col 
        ...
        {fields && (
          <motion.p
            ...
            className={`w-full p-2 rounded-lg text-center font-semibold ${alertStatus === 'danger'
              ...
              : 'bg-emerald-700 text-emerald-900'
              }`}>
        ...
        <div className='w-full oy-2 border-b border-gray-300 flex 
              items-center gap-2'>
          <MdFastfood />
          <input
            type="text"
        ...
        <div className='flex items-center w-full'>
          ...
          px-12 py-2 rounded-lg text-lg text-white font-semibold' onClick={saveDetail}>Save</button> 
